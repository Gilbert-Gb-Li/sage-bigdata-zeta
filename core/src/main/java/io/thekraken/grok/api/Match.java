...
public class Match {
    ...
    public void captures(boolean onlyKeys) {
        ...
        Map<String, String> mapped = GrokUtils.namedGroups(this.match,this.subject);
        for(Entry<String, String> pairs: mapped.entrySet()){

             String key = pairs.getKey();
            String value = pairs.getValue();
            if (onlyKeys && !pairs.getKey().startsWith("field"))
                continue;
            String kn = this.grok.getNamedRegexCollectionById(key);
    ...
    public String toJson(Boolean pretty) {
        ...
        return new JSONObject(capture).toJSONString();
    }
