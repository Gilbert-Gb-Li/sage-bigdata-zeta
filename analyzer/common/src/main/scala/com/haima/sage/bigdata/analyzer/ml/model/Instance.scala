...
package com.haima.sage.bigdata.analyzer.ml.model
...
/**
  ...
  */
private[analyzer] case class Instance(label: Double, weight: Double, features: Vector)
...
/**
  ...
  * @param features The vector of features for this data point.
  */
private[analyzer] case class OffsetInstance(
                                       label: Double,
                                       weight: Double,
                                       offset: Double,
                                       features: Vector) {
