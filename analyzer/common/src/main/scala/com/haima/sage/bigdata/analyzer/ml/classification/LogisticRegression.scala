...
package com.haima.sage.bigdata.analyzer.ml.classification

import com.haima.sage.bigdata.analyzer.ml.regression.{GeneralizedLinearModel, WithIterativeSolver, WithRegularizationOption}
...
/** Logistic regression using the ordinary least squares (OLS) estimator.
  ...
  * =Parameters=
  *
  *  - [[com.haima.sage.bigdata.analyzer.ml.regression.WithIterativeSolver.Iterations]]:
  * Maximum number of iterations.
  *
  *  - [[com.haima.sage.bigdata.analyzer.ml.regression.WithIterativeSolver.Stepsize]]:
  ...
  * performance.
  *
  *  - [[com.haima.sage.bigdata.analyzer.ml.regression.WithIterativeSolver.ConvergenceThreshold]]:
  * Threshold for relative change of sum of squared residuals until convergence.
  *
  *  - [[com.haima.sage.bigdata.analyzer.ml.regression.WithIterativeSolver.LearningRateMethodValue]]:
