...
import com.haima.sage.bigdata.analyzer.ml.optimization.BaumWelch
...
class HMM {
  ...
  /**
    ...
    */
  def initializeParameters(trainingData: DataSet[Array[(Int, Int)]],
                           numberOfStates: Int, numberOfObVocab: Int): Unit = {
