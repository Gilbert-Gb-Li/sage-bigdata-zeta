...
/**
 * A variation of {@link SpookyHash64} for use in applications that require only
...
public class SpookyHash64 {
     ...
     * @return computed hash code
     * @throws ArrayIndexOutOfBoundsException if the preconditions for
     *                                        <code>length</code> or <code>offset</code>
     *                                        do not obtain
     ...
     *               must be non-negative and no larger than {@code src.length() - start}
     * @return computed hash code
     * @throws ArrayIndexOutOfBoundsException if the preconditions for <code>length</code>
     *                                        or <code>offset</code> do not obtain
     * @throws IllegalArgumentException       if <code>length</code> is negative
     */
