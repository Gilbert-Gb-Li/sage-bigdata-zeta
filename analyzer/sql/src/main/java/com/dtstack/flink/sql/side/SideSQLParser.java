...
import com.dtstack.flink.sql.side.util.DtStringUtil;
...
public class SideSQLParser implements Serializable
{

    public Queue<Object> getExeQueue(String exeSql, List<String> sideTableSet) throws SqlParseException
    {
    ...
    private Object parseSql(SqlNode sqlNode, List<String> sideTableSet, Queue<Object> queueInfo){
        ...
        switch (sqlKind){
            ...
            case AS:
                ...
                return aliasInfo;
//            case UNION:
//                throw new RuntimeException("unsupport sql kind UNION");
        }

        return "";
    }

    private JoinInfo dealJoinNode(SqlJoin joinNode, List<String> sideTableSet, Queue<Object> queueInfo){
        ...
        tableInfo.setLeftTableAlias(StringUtils.isNotEmpty(leftTbAlias)? leftTbAlias: leftTbName);
        tableInfo.setRightTableAlias(StringUtils.isNotEmpty(rightTableAlias)? rightTableAlias: rightTableName);
    ...
    private boolean checkIsSideTable(String tableName, List<String> sideTableList){
