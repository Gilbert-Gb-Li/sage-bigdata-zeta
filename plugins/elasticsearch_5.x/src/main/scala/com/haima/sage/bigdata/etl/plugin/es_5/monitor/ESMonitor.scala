package com.haima.sage.bigdata.etl.plugin.es_5.monitor
...
import com.haima.sage.bigdata.etl.plugin.es_5.reader.ESLogReader
...
class ESMonitor(conf: ES5Source, parser: Parser[MapRule]) extends Monitor {
