 ...
 */
public class XContentBuilder implements BytesStream, Releasable, Flushable {
    ...
    static final Map<Class<?>, Writer> WRITERS;
    ...
    static {
        ...
        writers.put(BigDecimal.class, (b, v) -> b.value(((BigDecimal) v).doubleValue()));
        ...
        writers.put(BigInteger.class, (b, v) -> b.value(((BigInteger) v).longValue()));
    ...
    protected void unknownValue(Object value) throws IOException {
        if (value == null) {
            nullValue();
            return;
        }
